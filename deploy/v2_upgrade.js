// NOTE: this is an example upgrade script, it is currently not in use!

// deploy: npx hardhat deploy --network rinkeby --tags v2_upgrade
...
module.exports.tags = ["v2_upgrade", "upgrade", "v2"];
