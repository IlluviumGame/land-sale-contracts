...
// Source: https://github.com/OpenZeppelin/openzeppelin-contracts/blob/master/test/token/ERC721/ERC721.behavior.js
...
function shouldBehaveLikeERC721 (errorPrefix, owner, newOwner, approved, anotherApproved, operator, other, burnable = true) {
  ...
  if(burnable) describe('_burn', function () {
...
function shouldBehaveLikeERC721Enumerable (errorPrefix, owner, newOwner, approved, anotherApproved, operator, other, burnable = true) {
  shouldSupportInterfaces([
    'ERC721Enumerable',
  ]);
  ...
  context('with minted tokens', function () {
    ...
    describe('tokenByIndex', function () {
      ...
      if(burnable) [firstTokenId, secondTokenId].forEach(function (tokenId) {
